...
r1 = Restaurant.create(name: 'Chicargo pizza', address: '298 Atlantic Ave,Chicargo 11201')
r2 = Restaurant.create(name: 'PizzHut', address: '50 west 55th St, New York, NY 10019')
